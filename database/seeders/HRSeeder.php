...
class HRSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $allowancePool =             [
                ['label' => 'Housing Allowance', 'amount' => rand(5000, 12000)],
                ['label' => 'Commuter Allowance', 'amount' => rand(3000, 6000)],
                ['label' => 'Responsibility Allowance', 'amount' => rand(2000, 5000)],
            ];
        $deductionPool =             [
                ['label' => 'PAYE (KRA)', 'amount' => rand(3500, 9500)],
                ['label' => 'NSSF (Tier I & II)', 'amount' => 1080],
                ['label' => 'SHIF (Healthcare)', 'amount' => rand(1200, 2500)],
                ['label' => 'Housing Levy (1.5%)', 'amount' => rand(750, 1500)],
            ];
