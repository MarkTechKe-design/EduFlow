                    ...
                    <TabsContent value="employment" className="mt-4">
                        <Card className="border-slate-200 dark:border-slate-800">
                            <CardContent className="p-6">
                                ...
                                <InfoRow label="Salary"        value={staff.salary ? `KSh ${Number(staff.salary).toLocaleString()}` : undefined} />
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <form onSubmit={handleDocUpload} className="space-y-4 mt-2">
                        <div className="space-y-1.5">
                            ...
                            <Input value={data.title} onChange={e => setData('title', e.target.value)} placeholder="e.g. National ID, TSC Certificate, KRA PIN" />
