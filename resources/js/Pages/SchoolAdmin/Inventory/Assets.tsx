        ...
        <AppLayout title="Assets">
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {[
                        { label: 'Total Value', value: `KSh ${stats.total_value.toLocaleString()}`, color: 'text-indigo-600', icon: DollarSign },
                        ...
                        <TableBody>
                            {assets.data.length === 0 ? (
                                ...
                                <TableRow key={a.id}>
                                    ...
                                    <TableCell className="text-right text-sm text-slate-500">KSh {Number(a.purchase_price).toLocaleString()}</TableCell>
                                    <TableCell className="text-right font-semibold text-sm text-slate-900 dark:text-white">KSh {Number(a.current_value).toLocaleString()}</TableCell>
                                    <TableCell>
                ...
                <DialogContent className="sm:max-w-lg">
                    ...
                    <div className="space-y-4 mt-2 max-h-[70vh] overflow-y-auto pr-1">
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="space-y-1.5">
                                <Label>Purchase Price (KSh ) <span className="text-red-500">*</span></Label>
