                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <Card className="dark:bg-slate-900 border-slate-200 dark:border-slate-800">
                        ...
                        <CardContent className="grid grid-cols-3 gap-4">
                            {[
                                { key: 'timezone', label: 'Timezone', opts: [['Africa/Nairobi','Africa/Nairobi (EAT)'],['UTC','UTC'],['Asia/Kolkata','Asia/Kolkata (IST)'],['UTC','UTC'],['America/New_York','America/New_York'],['Europe/London','Europe/London']] },
                                { key: 'currency', label: 'Currency', opts: [['KES','KES (KSh)'],['USD','USD ($)'],['USD','USD ($)'],['INR','INR (₹)'],['GBP','GBP (£)']] },
