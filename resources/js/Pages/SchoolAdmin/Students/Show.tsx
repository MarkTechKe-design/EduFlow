...
import { ArrowLeft, Pencil, FileUp, Trash2, FileText, User, GraduationCap, Users, Download, Eye, ExternalLink } from 'lucide-react';
                                ...
                                {student.documents.map((doc) => (
                                    <div key={doc.id} className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <a
                                                href={`/school/students/documents/${doc.id}/view`}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center justify-center h-8 w-8 rounded-md text-slate-500 hover:text-indigo-600 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                                                title="View / Preview Document"
                                            >
                                                <Eye className="w-4 h-4" />
                                            </a>
                                            <a
                                                href={`/school/students/documents/${doc.id}/download`}
                                                className="inline-flex items-center justify-center h-8 w-8 rounded-md text-slate-500 hover:text-indigo-600 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
