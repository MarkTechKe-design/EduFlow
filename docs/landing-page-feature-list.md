# EduFlow Landing Page Feature List

> Purpose: Design brief for the product landing page on the EduFlow website.
...
5. Convert interested visitors into EduFlow trial and demo leads
...
- **Headline:** "EduFlow — School management for modern schools"
...
This section helps schools get started with EduFlow.
...
| Is there a cloud-hosted version? | Not officially. Self-host on your own server. EduFlow support can help with setup. |
...
| Can I get paid support? | Yes. Contact the EduFlow team for support plans. |
...
- EduFlow brand and product link
...
| Field | Value |
|---|---|
| Page title | EduFlow — Laravel + React school management platform | EduFlow |
| Meta description | EduFlow is a connected school management platform built with Laravel and React, covering attendance, fees, exams, payroll, and more. |
| Primary keywords | EduFlow school management platform, school ERP, Laravel school software, school management Laravel React |
