                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <Card className="dark:bg-slate-900 border-slate-200 dark:border-slate-800">
                        ...
                        <CardContent className="grid grid-cols-2 gap-4">
                            ...
                            <Field name="phone" label="Phone" placeholder="+254700000000" />
                            <div className="space-y-1.5">
                    ...
                    <Card className="dark:bg-slate-900 border-slate-200 dark:border-slate-800">
                        ...
                        <CardContent className="grid grid-cols-2 gap-4">
                            ...
                            <Field name="state" label="County" placeholder="Nairobi County" />
                        </CardContent>
                    </Card>
                    ...
                    <Card className="dark:bg-slate-900 border-slate-200 dark:border-slate-800">
                        ...
                        <CardContent className="grid grid-cols-3 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <Select defaultValue="Africa/Nairobi" onValueChange={(v) => setValue('timezone', v)}>
                                    <SelectTrigger className="h-9"><SelectValue /></SelectTrigger>
                                    <SelectContent>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Select defaultValue="KES" onValueChange={(v) => setValue('currency', v)}>
                                    <SelectTrigger className="h-9"><SelectValue /></SelectTrigger>
                                    <SelectContent>
                                        <SelectItem value="KES">KES (KSh)</SelectItem><SelectItem value="USD">USD ($)</SelectItem>
