<?php
$invoiceDir = __DIR__ . '/resources/views/invoices';
...
file_put_contents($invoiceDir . '/subscription-pdf.blade.php', $invoiceBlade);
echo "[SUCCESS] Created Canva-style downloadable tax invoice template in resources/views/invoices/subscription-pdf.blade.php\n";