...
A fully-featured, production-ready school management platform built with a modern Laravel + React stack. EduFlow supports schools of all sizes with connected academic, administrative, finance, and family workflows.

## Goals
- Provide a complete, production-ready school management platform
- Help schools discover and adopt EduFlow
