                ...
                <div className="grid grid-cols-2 gap-4 max-w-sm">
                    ...
                    <Card className="border-amber-200 dark:border-amber-900">
                        <CardContent className="p-4 flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-xl font-bold text-amber-600">KSh {summary.total_fine_est?.toLocaleString()}</p>
                            ...
                            <TableBody>
                                {overdue.map((iss, idx) => (
                                    <TableRow key={iss.id} className="bg-red-50/30 dark:bg-red-950/10">
                                        ...
                                        <TableCell className="text-right font-semibold text-amber-600">KSh {iss.estimated_fine?.toLocaleString()}</TableCell>
                                        <TableCell>
