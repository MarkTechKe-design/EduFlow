...
| Field | Value |
|---|---|
| Project | EduFlow School Management Platform |
...
|---|---|---|
| `APP_URL` | `https://eduflow.example.com` | Base URL |
...
| `AWS_BUCKET` | `eduflow-files` | File storage |
| `MULTITENANCY_MODE` | `subdomain` / `path` | Tenant routing |
| `SUPER_ADMIN_EMAIL` | `admin@eduflow.test` | First super admin |
