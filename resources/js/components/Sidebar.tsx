...
import { LayoutDashboard, School, Users, CreditCard, BookOpen, Calendar, Settings, Package, FileText, X, GraduationCap, ShieldCheck, Award, Bus, Building2, Video, HelpCircle, Newspaper, Layers, Clock, DollarSign, CheckSquare, FolderKanban, ShieldAlert, Radio } from 'lucide-react';
                    ...
                    <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex items-center gap-2.5 shadow-xs">
                        ...
                        <div className="space-y-0.5 truncate">
                            ...
                            <p className="text-xs font-bold text-white truncate">
                                {isSuperAdmin ? 'Super Administrator' : school?.name || 'School Operations'}
                            </p>
                        </div>
                    </div>
