...
export default defineConfig({
  title: 'EduFlow',
  description: 'EduFlow School Management Platform user guide',
  base: '/',
  ...
  themeConfig: {
    ...
    footer: {
      message: 'EduFlow School Management Platform',
      copyright: 'Copyright © 2026 EduFlow',
    },

    socialLinks: [
      { icon: 'github', link: 'https://github.com/your-org/eduflow' },
    ],
  },
})
